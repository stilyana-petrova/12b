...
namespace AirLineTicketsApp.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PlaneCode,Model,Picture,Luggage,Bar,Seats")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PlaneCode,Model,Picture,Luggage,Bar,Seats")] Plane plane)
        {
            if (id != plane.Id)
            {
                return NotFound();
